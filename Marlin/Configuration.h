...
#define STRING_CONFIG_H_AUTHOR "(Guilherme, 2020-06-12)" // Who made the changes.
 ...
 *
 *  1000 : Custom - Specify parameters in Configuration_adv.h - Edited with metamaquina's table
 *  1001 : Custom - I have created a thermistor_1001.h with the table from metamaquinas original FW
 *
...
//#define TEMP_SENSOR_BED 1001  // Thermistor de 15K da mesa da metamáquina
#define TEMP_SENSOR_BED 11  // Thermistor de vidro que veio com a mesa geeetech
 ...
 */
#define Z_MIN_PROBE_PIN P0_10 // Pin P0_10 is the SKR1.4 Turbo default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 36, 26, -1.30 }
